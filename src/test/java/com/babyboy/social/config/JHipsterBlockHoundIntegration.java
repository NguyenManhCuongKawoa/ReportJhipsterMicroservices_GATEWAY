...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.babyboy.social.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.babyboy.social.security.DomainUserDetailsService", "createSpringSecurityUser");
